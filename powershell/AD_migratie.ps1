...
function prep_ad_for_these_unspeakable_horrors {
    ...
    Write-host "All groups found in Directory, you may proceed, if you dare..."
    }

    Write-Host "Checking if objects"
...
-and (Get-FileHash -Path "C:\Users\knaakadmin\Downloads\fixed.ldif") -eq (Get-Content -Path C:\Users\knaakadmin\Desktop\importstatus.txt)[1]){
...
-and (Get-FileHash -Path "C:\Users\knaakadmin\Downloads\fixed.ldif" | Select-Object Hash) -ne (Get-Content -Path C:\Users\knaakadmin\Desktop\importstatus.txt)[1]) {
...
if (((Get-Content -Path C:\Users\knaakadmin\Desktop\importstatus.txt) -ne $set_status_1) -or ($im_stupid -eq "force")) {
    Write-Host "LDIF has not been imported"
...
$ERM_STU_users = (Get-ADUser -filter 'UserPrincipalName -like "Stud*"') 
...
Get-FileHash -Path "C:\Users\knaakadmin\Downloads\fixed.ldif" | Select-Object Hash | Add-Content -Path "C:\Users\knaakadmin\Desktop\importstatus.txt"
    }
